...
class SalesSummary(BaseModel):
    ...
    # Allow optional fields if schema changes
    class Config:
...
def get_sales_summary():
    """Retrieves aggregated sales data from the analytics store."""
    try:
        with engine.connect() as conn:
            # Execute query and map results to dictionary
        ...
        # Log the error internally here in a real app
